...
def define_hyperparameters():
    return {"dataset_path": "data/Landsat_NDVI_time_series_1984_to_2024.tif", "batch_size": 64, "num_workers": 4, "num_epochs": 100, "lr": 1e-3}
...
def create_dataloader(dataset_path, window_size, batch_size, num_workers, max_distance):
    ...
    loader = LandsatDataLoader(dataset, batch_size, train_rate=0.1, val_rate=0.01, num_workers=num_workers)
...
if __name__ == "__main__":
    ...
    use_pretrained = False  # Set this to False if you want to train models from scratch
